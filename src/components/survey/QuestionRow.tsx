...
//import types (QuestionRowProps) for typesafety. Look at "app/types/types.ts"
import { type QuestionRowProps } from '../../types/types';

// QuestionRow component renders individual questions with radio inputs and comment field
export default function QuestionRow({ question, onHelpClick, onRadioChange }: QuestionRowProps) {
  return (
